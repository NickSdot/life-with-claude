...
### B003: --agents flag agents invisible to Claude despite appearing in /agents
...
### F001: Plan mode compacts context too aggressively near completion
...
### F002: Compaction doesn't start automatically after Claude exhausts context
...
### F003: Task references use invisible IDs instead of visible titles
...
### W001: Add turnDurationOverride setting for custom turn duration messages
...
### B001: Bash tool duplicates output for failed commands
...
### B002: Unsupported model in agent config silently fails instead of erroring
