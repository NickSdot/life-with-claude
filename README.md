...
|------|----|----|-------|-------|
| 🐛 | B003 | 🟡 | [--agents flag agents invisible to Claude despite appearing in /agents](#b003---agents-flag-agents-invisible-to-claude-despite-appearing-in-agents) | [#33513](https://github.com/anthropics/claude-code/issues/33513) |
| 🤔 | F001 | 🟡 | [Plan mode compacts context too aggressively near completion](#f001-plan-mode-compacts-context-too-aggressively-near-completion) | [#29371](https://github.com/anthropics/claude-code/issues/29371) |
| 🤔 | F002 | 🟡 | [Compaction doesn't start automatically after Claude exhausts context](#f002-compaction-doesnt-start-automatically-after-claude-exhausts-context) | [#29780](https://github.com/anthropics/claude-code/issues/29780) |
| 🤔 | F003 | 🟡 | [Task references use invisible IDs instead of visible titles](#f003-task-references-use-invisible-ids-instead-of-visible-titles) | [#29800](https://github.com/anthropics/claude-code/issues/29800) |
| 💫 | W001 | 🟢 | [Add turnDurationOverride setting for custom turn duration messages](#w001-add-turndurationoverride-setting-for-custom-turn-duration-messages) | [#30979](https://github.com/anthropics/claude-code/issues/30979) |

### B003: --agents flag agents invisible to Claude despite appearing in /agents ([#33513](https://github.com/anthropics/claude-code/issues/33513))
...
### F001: Plan mode compacts context too aggressively near completion ([#29371](https://github.com/anthropics/claude-code/issues/29371))
...
### F002: Compaction doesn't start automatically after Claude exhausts context ([#29780](https://github.com/anthropics/claude-code/issues/29780))
...
### F003: Task references use invisible IDs instead of visible titles ([#29800](https://github.com/anthropics/claude-code/issues/29800))
...
### W001: Add turnDurationOverride setting for custom turn duration messages ([#30979](https://github.com/anthropics/claude-code/issues/30979))
...
| Type | ID | Prio | Title | Issue |
|------|----|----|-------|-------|
| 🐛 | B001 | 🔴 | [Bash tool duplicates output for failed commands](#b001-bash-tool-duplicates-output-for-failed-commands) | [#27621](https://github.com/anthropics/claude-code/issues/27621) |
| 🐛 | B002 | 🟡 | [Unsupported model in agent config silently fails instead of erroring](#b002-unsupported-model-in-agent-config-silently-fails-instead-of-erroring) | [#32415](https://github.com/anthropics/claude-code/issues/32415) |

### B001: Bash tool duplicates output for failed commands ([#27621](https://github.com/anthropics/claude-code/issues/27621))
...
### B002: Unsupported model in agent config silently fails instead of erroring ([#32415](https://github.com/anthropics/claude-code/issues/32415))
